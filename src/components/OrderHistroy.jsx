...
//     try {
//       const response = await fetch(`https://react-mern-back-end.onrender.com/orders/${orderId}`, {
//         method: 'DELETE',
//         headers: {
...
//                   </button>
//                   <button 
//                     className="rounded-full px-7 py-3 bg-red-600 shadow-sm shadow-transparent text-white font-semibold text-sm transition-all duration-500 hover:shadow-red-400 hover:bg-red-700" 
//                     onClick={() => handleDeleteOrder(order.id)} // Call handleDeleteOrder on click
//                   >
//                     Delete Order
//                   </button>
//                 </div>
