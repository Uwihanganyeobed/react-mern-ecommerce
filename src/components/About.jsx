        ...
        <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
          ...
          <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              ...
              <div class="flex flex-col items-center justify-center p-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 rounded-2xl shadow-lg text-white text-center">
                <h1 class="text-3xl md:text-4xl font-bold tracking-wide">
                  Kigali Fast Logistics
                </h1>
                <p class="text-lg md:text-4xl font-medium mt-1"> & Shopping</p>
              </div>
              ...
              <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                ...
                <p className="text-gray-500 text-base font-normal leading-relaxed lg:text-start text-center">
                  At KFLS, we believe in creating a seamless online shopping
                  experience. Our commitment to quality and customer
                  satisfaction drives us to continuously improve our offerings
                  and services.
                </p>
              </div>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  To provide Rwandans with a reliable and convenient online
                  shopping platform that meets their needs while supporting
                  local businesses.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  To be the leading e-commerce platform in Rwanda, known for our
                  exceptional service and commitment to customer satisfaction.
                </p>
              </div>
            </div>
