...
import { XMarkIcon, ChevronDownIcon, FunnelIcon, MinusIcon, PlusIcon, Squares2X2Icon, ChevronLeftIcon, ChevronRightIcon } from '@heroicons/react/20/solid';
...
export default function CollectionPage() {
  ...
  }, [currentPage, selectedSort, fetchProducts]);
              ...
              <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                ...
                {[...Array(5)].map((_, index) => (
                  <button
                    ...
                    className={classNames(
                      currentPage === index + 1 ? 'bg-indigo-50 border-indigo-500 text-indigo-600' : 'bg-white border-gray-300 text-gray-500 hover:bg-gray-50',
